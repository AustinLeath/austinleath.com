...
<html>
	<head>
		<title>Austin Leath | Tools</title>
		<meta charset="utf-8" />
	...
	<body id="background">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="">Austin Leath | Tools</a></h1>
					<nav id="nav">
						<ul>
							<li>
									<p id="timer"></p>
							...
							<!-- Content -->
							  <section id="content">
								...
								<section id="formdata">
															...
															<a class="downloadbtn" href="/images/img1.png" download><button class="button icon fa-download" type="button">Download Project</button></a>
										</section>
