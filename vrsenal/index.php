...
<html>
	<head>
		<title>Austin Leath | VRsenal</title>
		<meta charset="utf-8" />
		...
		<meta name="description" content="VRsenal is a single player VR game that is both an open world exploration game and physics simulation. Master the landscape as well as a variety of weapons that are laid before you!">
	...
	<body id="background">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="">Austin Leath | VRsenal</a></h1>
					<nav id="nav">
						<ul>
							<li>
								<p id="timer"></p>
								...
								<li>
								<button class="button small btnalign" id="btn2" type="button" onclick="myFunction1()" disabled>Dark Mode</button>
							<li>
					...
					<div class="container">
						...
						<!-- Content -->
							<section id="content">
								...
								<header class="major">
									<h3>Why I chose Early Access for VRsenal</h3>
									</header>
									<p>VRsenal is still in its early stages of development. So I would love to show the community what I have done so far and hear what everyone has to say as far as mechanics go. Things are a bit rusty at the moment but they will shape up soon!</p>
										...
										<p>The current state of the Early Access version is pre alpha. The game certainly isn't finished but with the help of the community this game will be a fun experience for everyone!</p>
