						...
						<a class="image fit"><img src="images/r6.jpg" alt="" /></a>
										<!-- Content -->
													...
													<!--Divider-->
															...
															You need to <?php $a = $_POST["rankfinal"]; $b = $_POST["MMR"];  $c = $_POST["ELO"]; if (($a - $b / $c < 0) { echo "win" ;} if (($a - $b / $c > 0) { echo "lose" ;};?> <?php $a = $_POST["rankfinal"]; $b = $_POST["MMR"];  $c = $_POST["ELO"]; echo ($a - $b) / $c ;?> (&plusmn; 0.5) games to reach your rank goal<br>
								</section>
					</div>
			</div>
