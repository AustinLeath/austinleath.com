...
<html>
	<head>
		<title>Austin Leath | Apache License</title>
		<meta charset="utf-8" />
		...
		<meta name="description" content="This page contains Austin Leath's Apache License, Austin is a young web engineer looking for work. If you would like to contact him send him an email at austinleath18@gmail.com">
	...
	<body id="background">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="">Austin Leath | Apache License</a></h1>
					<nav id="nav">
								 <ul>
		 							<li>
										<p id="timer"></p>
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
						<header class="major">
							<h2>Austin Leath | Apache License</h2>
							<p>The following page contains our Apache License</p>
						</header>
			...
			Copyright {2018} {LethalGameStudios}
