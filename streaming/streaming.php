...
<html>
	<head>
		<title>Austin Leath | Streaming</title>
		<meta charset="utf-8" />
	...
	<body>
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="">Austin Leath | Streaming</a></h1>
					<nav id="nav">
						<ul>
							<li>
							...
							<!--DIVIDER-->
							 ...
							 <!--DIVIDER-->
									 <li>
										 <a href="">Streaming</a>
											 <ul>
												<li><a href="gamesweplay.php">Games We Play</a></li>
												<li><a href="streamerswewatch.php">Streamers We Watch</a></li>
